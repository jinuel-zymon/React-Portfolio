    ...
    <div className="container">
      <div className="flex flex-col-reverse md:flex-row items-center gap-10">
        <div className="basis-[50%] text-center md:text-start">
          ...
          <Link to="/" className="uppercase relative bg-pale border border-black py-3 px-10 hover:bg-black hover:text-white transition-all rounded-lg inline-block mr-2 mb-2 after:content-[''] after:size-full after:bg-red-400 after:block after:absolute after:left-0 after:hidden">Resume</Link>
        </div>
